export const data = [
    ...
    },
    {
      ...
      image:
        "https://www.turizmgunlugu.com/wp-content/uploads/2021/08/malatya-Tohma-Kanyonu-696x418.jpg",
    },
    {
      id: 14,
      title: "Aveiro",
      desc:
        "Aveiro was used as an important port city until the 17th century. The canal, which runs through the city, is known as the 'Venice of Portugal' for its long, colorfully painted boats. Fishing, porcelain making, sandal making are the main livelihoods of Aveiro.",
      image:
